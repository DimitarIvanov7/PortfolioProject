...
import useInterval from "../../../../hooks/games/useInterval.js";
import checkCollision from "../../../../hooks/games/collisionDetection.js";
...
const Snake = ({ food }) => {
	...
	return (
		<>
			...
			<p style={{ color: "#66fcf1" }}>Score: {tailPosition.length - 3}</p>
		</>
	);
};
